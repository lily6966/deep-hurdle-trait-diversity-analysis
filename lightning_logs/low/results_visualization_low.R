setwd("/Users/liyingnceas/GitHub/Deep-hurdle-population-model-exp/lightning_logs/low")
...
for (j in 1:species_num){
  ...
  ggsave(paste0("occurance_plots_low/", bird_species, "_occurance_probability_historical.pdf"), plot = abundance_change, width = 8, height = 6, units = "in")
}
   

#--------------------------Range mapping------------------------------------
#create directory to save result
plot_dir <- "abundance_plots_low"
